...
\begin{definice}[Přeškálování simulace $s$ do intervalu $\langle 0, 1 \rangle$ ]
...
\begin{definice}[Přeškálování ceny $u$ do intervalu $\langle 0, 1 \rangle$ ]
...
Pro pohotovostní plány $y^{utopia} = \langle 1, 0 \rangle$, úspěšné odbavení všech incidentů za nulovou cenu.
Samozřejmě $p$, pro které $q(p) = y^{utopia}$ v $P_C$ nemůže existovat.
...
Můžeme však měřit, jak blízko $q(p)$ k $y^{utopia}$ je.
