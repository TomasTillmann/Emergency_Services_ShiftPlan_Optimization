...
\begin{definice}[Optimalizační úloha s jednou účelovou funkcí a s omezujícími podmínkami (\citet{AlgOptBook}, str. 169)]
  \begin{align*}
...
\\
\begin{definice}[Cena plánu]\label{df:cenaPlanu}
...
Víceúčelové funkce $q_{\alpha}, q_{\alpha p} \in Q_I$ které budeme maximalizovat jsou jen jednoduchou kombinací původních účelových funkcí $s$ a $u$.
...
V této kapitoly dáme tyto poznatky dohromady a zformulejeme N2CO.
