...
\begin{definice}[Přeškálování simulace $s$ do intervalu $\langle 0, 1 \rangle$ ] \label{df:simulaceSkal}
...
\begin{definice}[Přeškálování ceny $u$ do intervalu $\langle 0, 1 \rangle$ ] \label{df:cenaPlanuSkal}
