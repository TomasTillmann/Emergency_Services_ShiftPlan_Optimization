...
V krocích 2 až 6 simulace (viz algoritmus \ref{simulaceAlgo}) položí $s_I$ a $T$ rovno nule, setřídí si sadu incidentů podle časů nastání
...
Jednou metodou je převod víceúčelové funkce na jednu účelovou funkci, aby
...
v jakých jednotkách se měří. Při maximalizaci budou preferovány účelové funkce s oborem hodnot ve větším rozsahu.
