...
V přechozí sekci \ref{kap:dynamicProgram} jsme si ukázali, jak se obecně dynamickým programováním dá 
...
% Mohlo by se zdát, že provedením tahu snížení ceny $U$ by na množině incidentů $I$ plán $p \colon s_c(p, I) = r$ odbavoval méně nebo nanejvýš stejně incidentů, $s_c(U(p), I) \leq r$.
