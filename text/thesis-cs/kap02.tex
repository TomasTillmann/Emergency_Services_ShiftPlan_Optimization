...
\begin{dukaz}
  ...
  V algoritmu v kroku 7 množina $T^*_k$ obsahuje všechny optimální tahy, které lze provést na plánu $p$ na množině $I_k$, počínaje prázdným plánem a prvním incidentem.
...
případně i měnit různé metaheuristiky za běhu~\cite{GlovKoch03}.
...
Prostor porhledává prostřednictvním sousedů $N(x)$, kde vždy vybere souseda s nejlepší hodnotou účelové funkce.~(\cite{HybridMeta}, str. 3).
