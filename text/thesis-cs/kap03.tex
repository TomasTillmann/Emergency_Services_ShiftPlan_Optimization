...
V grafu \ref{img:naive} vidíme naivní řešení spuštěné po dobu 20 minut.
...
V této kapitole shrneme klíčová pozorování z předešlého aplikování jednotlivých metod a následně metody mezi sebou porovnáme. 
...
Přičemž při nižší finální teplotě by simulované žíhání konvergovalo k ještě lepšímu plánu, za cenu delšího běhu.
...
\hline
  SŽ -- náhodný plánu & 51:54 & 2124103 & 300 \\
\hline
  POT + SŽ & 21:15 & 2736133 & 300 \\
\hline
\end{tabular}
\caption{Shrnutí metod.}
